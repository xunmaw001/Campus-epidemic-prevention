  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="年级" prop="nianji">
              <el-input v-model="ruleForm.nianji" 
                placeholder="年级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="假期计划" prop="jiaqijihua">
          <el-select v-model="ruleForm.jiaqijihua" placeholder="请选择假期计划">
            <el-option
                v-for="(item,index) in jiaqijihuaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="假期计划" prop="jiaqijihua">
	      <el-input v-model="ruleForm.jiaqijihua"
                placeholder="假期计划" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="计划离校时间" prop="jihualixiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jihualixiaoshijian" 
                type="date"
                placeholder="计划离校时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jihualixiaoshijian" label="计划离校时间" prop="jihualixiaoshijian">
              <el-input v-model="ruleForm.jihualixiaoshijian" 
                placeholder="计划离校时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="计划回校时间" prop="jihuahuixiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jihuahuixiaoshijian" 
                type="date"
                placeholder="计划回校时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jihuahuixiaoshijian" label="计划回校时间" prop="jihuahuixiaoshijian">
              <el-input v-model="ruleForm.jihuahuixiaoshijian" 
                placeholder="计划回校时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交通工具" prop="jiaotonggongju">
          <el-input v-model="ruleForm.jiaotonggongju" 
              placeholder="交通工具" clearable  :readonly="ro.jiaotonggongju"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiaqiquxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaqiquxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
