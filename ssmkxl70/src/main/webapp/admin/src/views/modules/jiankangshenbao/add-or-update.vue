  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否发烧" prop="shifoufashao">
          <el-select v-model="ruleForm.shifoufashao" placeholder="请选择是否发烧">
            <el-option
                v-for="(item,index) in shifoufashaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否发烧" prop="shifoufashao">
	      <el-input v-model="ruleForm.shifoufashao"
          ...
          <el-form-item class="input" label="途径地" prop="tujingdi">
              <el-input v-model="ruleForm.tujingdi" 
                placeholder="途径地" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接触史" prop="jiechushi">
          <el-input v-model="ruleForm.jiechushi" 
              placeholder="接触史" clearable  :readonly="ro.jiechushi"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiankangshenbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiankangshenbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
