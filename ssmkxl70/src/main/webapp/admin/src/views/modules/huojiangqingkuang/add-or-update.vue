          ...
          <el-form-item class="input" label="班级" prop="banji">
              <el-input v-model="ruleForm.banji" 
                placeholder="班级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获奖证书名" prop="huojiangzhengshuming">
          <el-input v-model="ruleForm.huojiangzhengshuming" 
              placeholder="获奖证书名" clearable  :readonly="ro.huojiangzhengshuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获奖证书名" prop="huojiangzhengshuming">
              <el-input v-model="ruleForm.huojiangzhengshuming" 
                placeholder="获奖证书名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
