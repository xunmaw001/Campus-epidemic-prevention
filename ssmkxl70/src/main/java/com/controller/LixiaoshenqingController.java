...
public class LixiaoshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,LixiaoshenqingEntity lixiaoshenqing, 
		...
		if(tableName.equals("fudaoyuan")) {
			lixiaoshenqing.setFudaoyuangonghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LixiaoshenqingEntity lixiaoshenqing, HttpServletRequest request){
